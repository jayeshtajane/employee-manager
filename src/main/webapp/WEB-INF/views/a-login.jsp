...
<html lang="en">
  ...
  <body class="text-center bg-dark">
    <form class="form-signin" name="f" method="POST" action="admin_login">
  <img class="mb-4" src="./resources/img/clogo.jpg" alt="" width="72" height="72">
  <h1 class="h3 mb-3 font-weight-normal text-light">Administrator login</h1>
  ...
  <p class="mt-2"><a href="./e-login">Login as employee</a></p>
