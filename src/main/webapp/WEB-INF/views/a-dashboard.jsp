...
<main role="main" class="">
  <div class="my-3 p-3 bg-white rounded shadow-sm">
    ...
    <div class="row ml-2 mr-2">
      <div class="card text-white bg-dark mt-2" style="width: 15rem;">
        ...
        <div class="card-body text-center">
          ...
          <a href="./employee/all" class="card-link">View employees</a>
        </div>
      </div>

      <div class="card text-dark bg-warning mt-2" style="width: 15rem;">
        <div class="card-header">Total salary to pay</div>
        <div class="card-body text-center">
          <h3 class="card-text">&#x20b9;30,000</h3>
          <a href="./payments/salary" class="card-link">View salary</a>
        </div>
      </div>

      <div class="card text-white bg-primary mt-2" style="width: 15rem;">
        <div class="card-header">Last paid salary</div>
        <div class="card-body text-center">
          <h3 class="card-text">&#x20b9;20,500</h3>
          <a href="./payments/all" class="card-link text-dark">View list</a>
        </div>
      </div>

      <div class="card text-white bg-info mt-2" style="width: 15rem;">
        <div class="card-header">Bonus gives in last week</div>
        <div class="card-body text-center">
          <h3 class="card-text">&#x20b9;1,500</h3>
          <a class="card-link text-info">.</a>
        </div>
      </div>
    </div>
    <hr>
    ...
    <div class="media pt-3 pl-3 bg-success">
      <svg class="bd-placeholder-img mr-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32"><title>Placeholder</title><rect width="100%" height="100%" fill="#007bff"></rect><text x="50%" y="50%" fill="#007bff" dy=".3em">32x32</text></svg>
      <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
        <strong class="d-block text-gray-dark">Employee added.</strong>
        Jayesh Kisan Tajane
        <br>
    ...
    <div class="media pt-3 pl-3 bg-secondary">
      ...
      <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
        <strong class="d-block text-gray-dark">Attendence updated.</strong>
        Jayesh Kisan Tajane
        <br>
        <span class="badge badge-warning">15/08/2019</span>
        <span class="badge badge-info">11.30 PM</span>
    ...
    <div class="media pt-3 pl-3 bg-danger">
    ...
    <div class="d-block text-right mt-3">
      <a href="./a-dashboard/notifications">View all</a>
    </div>
