...
<main role="main" class="container">
  ...
  <div class="my-3 p-3 bg-white rounded shadow-sm">
    <div class="row">
      <div class="col-sm-6">
        <span class="h3">Attendence <button type="button" class="btn btn-primary ml-2">Submit</button></span>
      </div>
      <div class="col-sm-6">
          ...
          <tr>
            ...
            <td>
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="customCheck3">Present</label>
              </div>
            </td>
          </tr>
          <tr>
    ...
    <div>
      <a href="./all">View all days attendece</a>
    </div>
  </div>
</main>
